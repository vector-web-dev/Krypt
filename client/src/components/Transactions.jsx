        ...
        ">
            <div className="flex flex-col items-center w-full md-3">
                <div className="w-full mb-2 p-2">
                    ...
                    <img src={gifUrl || url} alt="gif" className="w-full h-64 2xl:h-6 shadow-lg rounded-md object-cover" />

                    <div className="bg-black p-3 px-5 w-maxx rounded-3xl -mt-5 shadow-2xl">
